...
-- run_once({
--     -- "[[ -z $(systemctl --user status clipmenud | grep -ow active) ]] && DISPLAY=:1.0 systemctl --user start clipmenud",
--     "unclutter --exclude-root",
--     "compton --config ~/.config/compton/compton-xephyr.conf"
-- })
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_width,
                     ...
                     placement = awful.placement.no_overlap+awful.placement.no_offscreen, { honor_workarea = true },
