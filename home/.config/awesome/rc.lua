...
-- Switcher settings
-- switcher.settings.preview_box_title_font = {"Ace Futurism 12","italic","normal"} -- the font for cairo
-- switcher.settings.cycle_raise_client = false -- raise clients on cycle
-- switcher.settings.preview_box_title_font_size_factor = 0.9 -- the font sizing factor
-- switcher.settings.preview_box_fps = 59 -- refresh framerate
...
naughty.config.defaults.font = "Misc Ohsnap.Icons 8"
naughty.config.defaults.icon = os.getenv("HOME") .. "/Downloads/icons/info-128.png"
...
--     "wmname LG3D",
--     -- string.format(
--     --     "devmon --exec-on-drive %q --exec-on-unmount %q",
--     --     "notify-send --icon=/home/d0np0br3/Pictures/usb_drive128.png --urgency=low \"Volume %l has been mounted.\"",
--     --     "notify-send --icon=/home/d0np0br3/Pictures/black_drive_usb.png --urgency=low \"Volume %l has been unmounted\""
--     -- ),
--     "urxvtd -q -o -f",
...
local notify_cmd = [[
    sh -c 'awesome -v | head -n1; systemctl --failed | head -n1; systemd-analyze'
]]
...
local editor       = terminal .. " -e " .. os.getenv("EDITOR") or "vim"
...
awful.rules.rules = {
    ...
    { rule = { class = "Firefox", "Chromium", "Google Chrome" },
    ...
    { rule_any = { class = {"Zathura", "Galculator", "Xarchiver", "feh", "Sxiv"} },
